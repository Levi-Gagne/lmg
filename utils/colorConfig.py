...
class C:
    ...
    # Use these to differentiate cluster headers and details.
    ...
    CLUSTER_TERTIARY   = '\033[38;2;50;205;50m'    # Medium Sea Green – for driver/executor labels
    CLUSTER_QUATERNARY = '\033[38;2;173;255;47m'   # Light Green – for detailed values or supplementary info
